...
const Footer = () => {
    ...
    return (
    <footer>
        <div className="bg-woodsmoke-900/80 min-h-48 flex font-body justify-between border-t border-woodsmoke-800 items-center text-mercury-400 px-6 md:px-12 lg:px-16 xl:px-24 pt-8 md:pt-24 pb-16">
