...
const Footer = () => {
    ...
    return (
    <footer>
        <div className="bg-woodsmoke-900 min-h-48 flex font-body justify-between border-t-1 border-woodsmoke-700 items-center text-mercury-400 px-8 md:px-32 pt-8 md:pt-24 pb-16">
